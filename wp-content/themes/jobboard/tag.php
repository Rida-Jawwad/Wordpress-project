...
<section class="section-hero overlay inner-page bg-image single-job-page" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold" style="text-transform:capitalize;"><?php echo $tag->name; ?></h1>
...
<?php 
$jobs = new WP_Query( array( 'post_type' => 'jobs' ,'tag_id' => $tag->term_id) );                
if ( $jobs->have_posts() ) { ?>    
  ...
  <ul class="job-listings mb-5">
          ...
          $tag = get_queried_object();
            $the_query = new WP_Query( array('posts_per_page'=>4,
                  'post_type'=>'jobs', 'tag_id'         => $tag->term_id,
