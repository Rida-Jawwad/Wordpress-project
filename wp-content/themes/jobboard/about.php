...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/hero_1.jpg');" id="home-section">
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/hero_1.jpg');">
      <div class="container">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
              <span class="play-icon"><span class="icon-play"></span></span>
              <img src="<?php echo get_template_directory_uri(); ?>/images/sq_img_8.jpg" alt="Image" class="img-fluid img-shadow">
            </a>
          </div>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            <img src="<?php echo get_template_directory_uri(); ?>/images/person_6.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>
          ...
          <div class="col-md-6 order-md-2 ml-md-auto">
            <img src="<?php echo get_template_directory_uri(); ?>/images/person_5.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>
