	...
	*/
	function init(){
		...
		$this->javascriptVariables = array(
									...
									'summary_length' => get_option('search_in_place_advanced_summary_char_number', 20),
    ...
    public function populate() {
        ...
        foreach($posts as $result){
			...
			if(get_option('search_in_place_display_summary', 1)){
				...
				$obj->resume = preg_replace('/('.$s.')/i', '<strong>$1</strong>', $summary).'<span class="ellipsis">[...]</span>';
			}
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<input type="text" name="search_in_page_selectors" style="width:100%;" value="'.esc_attr(implode(',', $search_in_page_selectors)).'">
